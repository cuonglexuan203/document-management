...
function Filter({ sidebarOpen, setSidebarOpen, onDocumentClick }: any) {
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="sidebar-content overflow-y-auto max-h-[calc(100vh-10rem)]">
            ...
            <div className={`overflow-hidden transition-all ${!verExpanded ? "h-0" : ""}`}>
              {/*Ascending*/}
          ...
          {/*Ministry list*/}
            ...
            {/*List ministry*/}
            <div className={`overflow-hidden transition-all ${!sidebarExpanded ? "h-0" : ""}`}>
              <div className="space-y-6">
