            ...
            <div className="mt-14 block p-6 border rounded my-2 border-gray-100 bg-gray-100">
                ...
                <div className="mt-10 mx-8">
                    <div className="mb-6 flex items-center">
                        <label htmlFor="default-input" className="font-bold text-2xl mr-9 w-32 items-center justify-center">Ministry</label>
                        <input type="text" id="default-input" className="bg-gray-50 border border-gray-50 text-base rounded-lg block w-full p-2.5" />
                    </div>
                    <div className="mb-6 flex items-center">
                        <label htmlFor="default-input" className="font-bold text-2xl mr-5 w-32 items-center justify-center">Description</label>
                        <input type="text" id="default-input" className="bg-gray-50 border border-gray-50 text-base rounded-lg block w-full p-2.5" />
                    </div>
                    <div className="mb-6 flex items-center">
